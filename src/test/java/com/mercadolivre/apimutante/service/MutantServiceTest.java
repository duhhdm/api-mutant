...
public class MutantServiceTest {
    ...
    public void isMutantReturnHorizontalTrue(){
        ...
        Mockito.when(dnaRepository.save(DnaModel.convertDnaEntity(dna.toString(), MutantEnun.MUTANT.toString()))).thenReturn(DnaModel.convertDnaEntity(dna.toString(), MutantEnun.MUTANT.toString()));
